...
let args_xh = {
     ...
     * 默认为0
     * */
    jdPrice: process.env.JD_TRY_PRICE * 1 || 149,
    /*
     ...
     * 默认为 1 到 5
     * */
    tabId: process.env.JD_TRY_TABID && process.env.JD_TRY_TABID.split('@').map(Number) || [1,2,3,4,5,7,10,12],
    /*
...
function requireConfig(){
    return new Promise(resolve => {
        ...
        if(typeof process.env.JD_TRY_PASSZC === "undefined") args_xh.passZhongCao = false;
        else args_xh.passZhongCao = process.env.JD_TRY_PASSZC === 'false';
