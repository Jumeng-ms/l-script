...
let args_xh = {
     ...
     * 默认为 1 到 10
     * */
    tabId: process.env.JD_TRY_TABID && process.env.JD_TRY_TABID.split('@').map(Number) || [1,2,3,4,5,6,7,8,10,12,13,14,15,16],
    /*
     ...
     * 默认为3000，也就是3秒
     * */
    applyInterval: process.env.JD_TRY_APPLYINTERVAL * 1 || 7000,
    /*
     ...
     * */
    maxLength: process.env.JD_TRY_MAXLENGTH * 1 || 600,
    /*
...
function requireConfig() {
    return new Promise(resolve => {
        ...
        if (typeof process.env.JD_TRY_UNIFIED === "undefined") args_xh.unified = true;
